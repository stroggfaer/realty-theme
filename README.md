...
3. **Установите плагин Pods:**
   - Перейдите в **Плагины → Добавить новый**
   - Найдите **Pods — Custom Content Types and Fields**
   - Установите и активируйте плагин

4. **Импортируйте настройки полей Pods:**
   - Перейдите в Панель администратора → **Pods Admin → Tools → Import Packages**
   - Выберите файл `pods-package-import.json` (находится в папке темы `wp-content/themes/realty-theme/`)
   - Нажмите **Import**
   - После импорта настройки полей и типов записей будут загружены

5. **Готово!** Тема активирована и готова к использованию.
